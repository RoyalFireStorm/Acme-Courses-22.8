...
@Service
public class TeacherLabTutorialCreateService implements AbstractCreateService<Teacher, Tutorial>{
	...
	public Tutorial instantiate(final Request<Tutorial> request) {
		...
		result.setType(TutorialType.LAB);
	...
	public void validate(final Request<Tutorial> request, final Tutorial entity, final Errors errors) {
	    ...
	    errors.state(request, !negativeMoney, "cost", "teacher.tutorial.error.negativeMoney");
